    ...
    **Attributes**:
    ...
    def _create_and_replace(
        ...
        kwargs = {
            "r": r,
            "lora_alpha": alpha,
            "num_gates": lora_config.num_gates,
        ...
        for active_adapter in self.active_adapters:
            ...
            if bias == "all":
                ...
                for m in model.modules():
                    if isinstance(m, LoraMoeConfig) and hasattr(m, "bias") and m.bias is not None:
    ...
    def set_adapter(self, adapter_name: str | list[str]) -> None:
        ...
        """
        for module in self.model.modules():
            if isinstance(module, LoraMoeConfig):
                if module.merged:
    ...
    def add_weighted_adapter(
        ...
        for key in key_list:
            ...
            if isinstance(target, LoraMoeConfig):
